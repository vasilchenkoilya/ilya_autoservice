"""
Django settings for ilya_autoservice project.
...
ALLOWED_HOSTS = ['autoservice.local', 'localhost']
...
ROOT_URLCONF = 'ilya_autoservice.urls'
...
WSGI_APPLICATION = 'ilya_autoservice.wsgi.application'
